...
class Records {
	...
	public function updateRecord(){
		...
		if($this->id) {
			...
			SET name= ?, kode_id = ?, username = ?, password = ?, role = ?
			WHERE id = ?");

			$this->id = htmlspecialchars(strip_tags($this->id));
			$this->name = htmlspecialchars(strip_tags($this->name));
			$this->kode_id = htmlspecialchars(strip_tags($this->kode_id));
			$this->username = htmlspecialchars(strip_tags($this->username));
			$this->password = htmlspecialchars(strip_tags($this->password));
			$this->role = htmlspecialchars(strip_tags($this->role));


			$stmt->bind_param("sisssi", $this->name, $this->kode_id, $this->username, $this->password, $this->role, $this->id);
	...
	public function addRecord(){
		...
		if($this->name) {
			...
			$stmt = $this->conn->prepare("
			INSERT INTO ".$this->recordsTable."(`name`, `kode_id`, `username`, `password`, `role`)
			VALUES(?,?,?,?,?)");
			...
			$stmt->bind_param("sisss", $this->name, $this->kode_id, $this->username, $this->password, $this->role);
